...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        jsonWriter.writeInJSONFile(metro.getMetroObject(),"C:/Skillbox/java_basics/FilesAndNetwork/DataCollector/src/main/resource/metro.json");
        //JSONReader jsonReader = new JSONReader();
        //jsonReader.getAmountOfStations("C:/Skillbox/java_basics/FilesAndNetwork/DataCollector/src/main/resource/metro.json");

        DataCollector collector = new DataCollector();
        collector.fileReader("C:/Skillbox/java_basics/FilesAndNetwork/DataCollector/src/main/resource/data");
        ...
        jsonWriter1.writeInJSONFile(stationObject, "C:/Skillbox/java_basics/FilesAndNetwork/DataCollector/src/main/resource/stations.json");
    }
